...
class CNN(object):
    ...
    def fit(self, x_train, y_train, x_valid, y_valid, n_epoch=10):
        ...
        self.n_train_batches = int(self.x_train.get_value(borrow=True).shape[0] / self.batchsize)
        self.n_valid_batches = int(self.x_valid.get_value(borrow=True).shape[0] / self.batchsize)
        ...
        while epoch < self.n_epoch:
            ...
            acc.append(0.0)
            loss.append(0.0)
            for batch_index in tqdm(range(self.n_train_batches)):
            ...
            val_acc.append(0.0)
            val_loss.append(0.0)
            for batch_index in range(self.n_valid_batches):
